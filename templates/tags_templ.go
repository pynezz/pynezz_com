...
func Tags(tags map[string]int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for tag, freq := range tags {
			...
			var templ_7745c5c3_Var7 templ.SafeURL = templ.SafeURL("/tags/" + strings.Trim(tag, "'"))
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<span class=\"text-subtext0 font-mono text-sm\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
